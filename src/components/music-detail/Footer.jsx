...
export default function Footer() {
  ...
  return (
    <section className="sticky bottom-0 flex justify-center h-[72px] bg-thirdGray xl:w-[1400px] lg:w-[1000px] md:w-[750px] sm:w-[600px] w-[350px] lg:px-10 md:px-6 sm:px-4 px-2">
          ...
          {openVolume && (
            <div className="absolute flex items-center justify-center w-[40px] h-[153px] top-0 left-0 border rounded bg-thirdGray -translate-y-[116%] -translate-x-2 ">
              <input
                ...
                className="absolute footer-volume"
